# Generated by Django 3.2.2 on 2021-05-24 20:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(verbose_name='Ссылка на рецепт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Ссылка на тэг')),
                ('fon_style', models.CharField(max_length=120)),
            ],
            options={
                'verbose_name': 'Тэг',
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(related_name='tags', through='recipes.TagRecipe', to='recipes.Tag', verbose_name='Тэг'),
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
